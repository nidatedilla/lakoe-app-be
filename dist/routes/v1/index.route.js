...
const withdrawal_route_1 = __importDefault(require("./withdrawal.route"));
...
router.use('/withdrawal', withdrawal_route_1.default);
router.use('/bank', auth_middlewere_1.auth, bank_route_1.default);
